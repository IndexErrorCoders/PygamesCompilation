...
class Level(mainscreen.MainScreen):
    ...
    def initLevel(self):
        ...
        #
        return [
            ('repeller-btn.png', gamecommon.heliumRepeller, 1),
...
Level.conversation_logic = [
    (
        ...
        [
            (m.Say, 'Sam, the miner unit has located some Helium-4. The harvester <br>'
                    ' cannotprocess this and it reacts with the Helium-3. you <br>'
                    ' need to keep the Helium-4 out of the harvester.'),
    ...
    (
        ...
        [
            (m.Say, 'This is a new repeller unit, Sam. It only repels the Helium-3 but<br>'
                    ' has no effect on the Helium-4.'),
        ]
    ),
    (
    ...
    (
        ...
        [
            (m.Say, 'Nicely done. I have been working on a new harvester that should be<br>'
                    ' able to process this new strain of Helium. Let\'s go and try that out.'),
        ]
    ),
    (

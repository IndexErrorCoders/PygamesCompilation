...
class Level(mainscreen.MainScreen):
    ...
    def initLevel(self):
        ...
        self.tweens.append(
            engine.Tween(
                e2, 'position', pymunk.Vec2d(750, 700), pymunk.Vec2d(450, 700), 5,
...
Level.conversation_logic = [
    (
        'Not doing well', True,
        [
            lambda w: w[m.W_SCORED_NEGATIVE] < -50,
        ],
        [
            (m.ChangeState, m.S_CONCERNED),
            (m.Say, 'You know Sam, you can move the objects once you have place them. <br>'
                    ' You can <i>move</i> them a lot in fact.'),
            (m.Hide, ),
        ]
    ),
    (

...
Level.conversation_logic = [
    (
        ...
        [
            (m.Say, 'Sam, the harvester is on the wrong side of the Helium mine. <br>'
                    'The repulsion unit on the left might be useful here.'),
    ...
    (
        ...
        [
            (m.Say, 'Sam, remember that you can rotate the unit you are dragging.<br>'
                    'Use the mouse wheel while you are dragging.'),
            (m.Set, m.W_INITIAL, False),
        ]
    ),
    (

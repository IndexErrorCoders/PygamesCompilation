...
METADATA = {
    'name':APP_NAME,
    'version':          aranara.common.version,
    'license':          'short_licence',
    'description':      'The banished returns',
...
PACKAGEDATA = {
    ...
    'package_dir': {'aranara': 'aranara',
                   },
    'packages': ['aranara',
                ],
    'scripts': ['scripts/aranara'],
}
...
print '\n\nData', _DATA_DIR, data_dirs

PACKAGEDATA['package_data'] = {'aranara': data_dirs}

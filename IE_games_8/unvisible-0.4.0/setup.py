...
METADATA = {
    ...
    'description':      'one room, one hit man, one target, one outcome?',
    'author':           'Paul Paterson',
    #'author_email':     '',
    'url':              'http://perpetualpyramid.com/drupal/?q=unvisible_game',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'unvisible': 'unvisible',
                   },
    'packages': ['unvisible',
                ],
    'scripts': ['scripts/unvisible'],
}
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'unvisible': data_dirs}
...
src = []
add_files(src,os.walk('unvisible'))

...
theme.load({
    'main': ('', {
        ...
        'screen-height': H,
        'screen-width': W,
        'screen-title': 'automusic',
        'screen-icon-filename': 'icon.png',
        'screenshot-size': (0, 0, W, H),

        # Sound grid properties
        'grid-width': 300,
        'grid-height': 300,
        'grid-position': (W / 2, H / 2),
        'grid-background-colour': (0, 0, 255, 50),
        #
        'grid-size': (7, 7),
        'grid-frequency': 50,
        'grid-frequency-options': [10 + 20 * i for i in range(10)],

        # Frequencies menu
        'frequencies-on-colour': (0, 255, 255),
        'frequencies-off-colour': (0, 255, 255, 50),
        'frequencies-item-width': 25,
        'frequencies-width': 300,
        'frequencies-height': 25,
        'frequencies-font-size': 12,
        'frequencies-position': (W / 2, H - 100),

        # BPM
        'bpm-position': (W / 2, H - 130),
        'bpm-colour': (255, 255, 255),
        'bpm-font-size': 12,

        # Instrument menu
        'instruments-on-colour': (0, 255, 255),
        'instruments-off-colour': (0, 255, 255, 50),
        'instruments-item-width': 100,
        'instruments-width': 400,
        'instruments-height': 25,
        'instruments-font-size': 12,
        'instruments-menu-position': (W / 2, H - 40),

        # Instrument label
        'instruments-position': (W / 2, H - 70),
        'instruments-colour': (255, 255, 255),
        'instruments-font-size': 12,

        # Buttons
        'pause-button-position': (W / 2 + 50, 100),
        'play-button-position': (W / 2 - 50, 100),

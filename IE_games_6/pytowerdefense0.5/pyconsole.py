...
font_path = os.path.join(path, "images/fonts")
...
class Console:
    ...
    def init_default_cfg(self):
        ...
        self.motd = ["[PyConsole 0.7]","Type help for a list of commands", "press Ctrl_w to hide the console"]
                ...
                ## Normal character printing
                    ...
                    if mods & KMOD_CTRL:
                        ...
                        try:
                            ...
                            self.output("Could not parse key!")
